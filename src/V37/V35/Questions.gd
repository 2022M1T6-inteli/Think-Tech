...
var ListaQ1Dim1_2=["Qual cor é a combinação de vermelho e amarelo?"]
var ListaQ2Dim1_2=["Qual a raiz quadrada de 49?"]
var ListaQ3Dim1_2=["Qual é o animal nacional?"]
var ListaQ4Dim1_2=["Qual animal está na nota de cinco reais?"]
var ListaQ5Dim1_2=["Quantas vezes o Brasil ganhou a copa do mundo"]
var ListaQ6Dim1_2=["Qual a capital dos Estados Unidos"]
var ListaQ7Dim1_2=["Quantas estrelas têm na bandeira do brasil"]
var ListaQ8Dim1_2=["1+1?"]
var ListaQ9Dim1_2=["Em que ano o Inteli foi fundado?"]
var ListaQDim1_2=[ListaQ1Dim1_2,ListaQ2Dim1_2,ListaQ3Dim1_2,ListaQ4Dim1_2,ListaQ5Dim1_2,ListaQ6Dim1_2,ListaQ7Dim1_2,ListaQ8Dim1_2,ListaQ9Dim1_2]

var ListaA1Dim1_2=["laranja","verde","roxo","azul"]
var ListaA2Dim1_2=["7","8","9","6"]
var ListaA3Dim1_2=["sabiá","arara","macaco","onça"]
var ListaA4Dim1_2=["garça","onça","mico-leão-dourado","peixe"]
var ListaA5Dim1_2=["5","4","6","3"]
var ListaA6Dim1_2=["Washington","Nova Iorque","Los Angeles","Miami"]
var ListaA7Dim1_2=["27","25","20","15"]
var ListaA8Dim1_2=["2","3","1","22"]
var ListaA9Dim1_2=["2022","2021","2020","2019"]
var ListaADim1_2=[ListaA1Dim1_2,ListaA2Dim1_2,ListaA3Dim1_2,ListaA4Dim1_2,ListaA5Dim1_2,ListaA6Dim1_2,ListaA7Dim1_2,ListaA8Dim1_2,ListaA9Dim1_2]
...
var ListaQDim2=[ListaQ1Dim2,ListaQ2Dim2,ListaQ3Dim2,ListaQ4Dim2,ListaQ5Dim2,ListaQ6Dim2,ListaQ7Dim2,ListaQ8Dim2,ListaQ9Dim2]
var ListaQ1Dim2=["What is the one expected outcome present in all Roadmap maturity levels?"]
var ListaQ2Dim2=["At what maturity level is the Team expected to be proactively considering the needs of the users to drive roadmap decisions?"]
var ListaQ3Dim2=["What is the best way to define maturity level 2?"]
var ListaQ4Dim2=["The existing version of the Roadmap is a useful input for all Roadmap maturity levels, except:"]
var ListaQ5Dim2=["What is the best way to define maturity level 1?"]
var ListaQ6Dim2=["What is the best way to define maturity level 3?"]
var ListaQ7Dim2=["Periodically updating a roadmap to reflect latest information is considered a good next step in which Roadmap maturity level?"]
var ListaQ8Dim2=["Which of these inputs is suggested at maturity level 3"]
var ListaQ9Dim2=["Which of these inputs is suggested at maturity level 2 and 3"]
...
var ListaA5Dim2=["Team is unaware or does not maintain a product roadmap​.","Team is able to adjust Roadmap based on management decisions.","Team can adjust product roadmap based on user needs​.","Team has a testable outcome-based Product Roadmap through user and stakeholder input."]
var ListaA6Dim2=["Team can adjust product roadmap based on user needs.​","Team is able to adjust the Roadmap based on management decisions.","Team has a testable outcome-based Product Roadmap through user and stakeholder input.","Team reviews Product Roadmap every quarter."]
var ListaA7Dim2=["Level 3","Level 1","Level 2","Level 4"]
var ListaA8Dim2=[" 2x2 a tool for priorization (for example: Priority matrix)."," User research inputs.","Data Analytics inputs.","Product Line Manager inputs."]
var ListaA9Dim2=[" Inputs from Stakeholder meetings.","Existing Version of Roadmap.","OGSM.","User Research Inputs."]
var ListaADim2=[ListaA1Dim2,ListaA2Dim2,ListaA3Dim2,ListaA4Dim2,ListaA5Dim2,ListaA6Dim2,ListaA7Dim2,ListaA8Dim2,ListaA9Dim2]
